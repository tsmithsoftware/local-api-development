...
function getSequelizeClient () {
  return new Promise((resolve, reject) => {
    const initialAttempt = new Sequelize('db', 'user', 'password', {
      host: 'db',
      dialect: 'mysql'
    })
    initialAttempt
      ...
      .catch(_ => {
        const secondAttempt = new Sequelize('db', 'user', 'password', {
        ...
        secondAttempt
          ...
          .catch(async _ => {
            const finalAttempt = new Sequelize('db', 'user', 'password', {
              host: 'localhost',
              dialect: 'mysql'
            })
